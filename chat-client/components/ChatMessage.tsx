  ...
  return (
    <div className="flex w-full my-1 justify-center">
      <div className="max-w-3xl w-full">
        ...
        <div className="ml-10 px-4 py-3 rounded-2xl shadow-sm bg-gray-200 text-gray-800 inline-block">
...
const ChatMessageComponent = React.memo(function ChatMessageComponent({
  message,
  onAddToCart,
  onCheckout,
  ...
  if (isUser) {
    return (
      <div className="flex w-full my-1 justify-center">
        <div className="flex items-start gap-2 max-w-3xl w-full justify-end">
          <div className="max-w-xs md:max-w-md lg:max-w-2xl px-4 py-2 rounded-2xl shadow-sm bg-blue-500 text-white">
    ...
    <div className="flex w-full my-1 justify-center">
      <div className="max-w-3xl w-full">
        ...
        <div className="ml-10 flex-grow min-w-0">
          {message.text && (
            <div className="max-w-xs md:max-w-md lg:max-w-2xl px-4 py-2 rounded-2xl shadow-sm bg-gray-200 text-gray-800 inline-block">
