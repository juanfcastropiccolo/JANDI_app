...
export const PlasmaShader = {
  ...
  fragment: `
    ...
    void main() {
      ...
      float noise2 = snoise(pos * 2.0 + vec3(t * 0.5, t * 0.3, t * 0.1));
      float noise3 = snoise(pos * 4.0 + vec3(t * 0.8, t * 0.6, t * 0.4));
      ...
      vec3 finalColor = plasmaColor + vec3(glow * 0.5);
      
      // Brillo adicional basado en energía de audio
      finalColor += vec3(uAudioEnergy * 0.2);
      
      // Transparencia basada en el glow y energía
      float alpha = 0.85 + uAudioEnergy * 0.15;
